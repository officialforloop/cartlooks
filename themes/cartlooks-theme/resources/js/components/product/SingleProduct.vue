<template>
  ...
  <div class="list-style-product" v-else-if="listStyle">
    <div
      class="single-product-item single-product product-horizontal align-items-center"
    >
      <!-- Product Image -->
  ...
  <!--Featured Style-->
  <div
    class="single-product-item featured-style d-flex flex-column"
    v-else-if="featuredStyle"
  >
    <div class="position-relative overflow-hidden">
      <!-- Thumb -->
      <router-link
      ...
      >
        <v-lazy-image
          class="w-100"
          :src="featuredImage != null ? featuredImage : item.thumbnail_image"
          :alt="item.name"
        />
      </router-link>
      <!-- End Thumb -->
