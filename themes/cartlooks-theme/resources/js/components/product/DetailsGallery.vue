    ...
    <div class="carousel-wrapper">
      ...
      >
        ...
        >
          ...
          >
            <img
              src="/public/web-assets/frontend/themes/cartlooks-theme/assets/img/play-big.png"
        ...
        >
          ...
          <div class="item-gallery__image-wrapper" v-else>
            <img
              ...
              src="/public/web-assets/frontend/themes/cartlooks-theme/assets/img/play-show.png"
    ...
    <ul class="nav share-list justify-content-center my-3">
      ...
      >
        ...
        >
          <img
            class="rounded"
            :src="`/public/web-assets/frontend/themes/cartlooks-theme/assets/img/social/${network.icon}`"
            :alt="network.name"
          />
        </ShareNetwork>
      </li>
