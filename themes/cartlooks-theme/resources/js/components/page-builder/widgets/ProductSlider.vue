<template>
  <section class="product-slider-section home-page-section">
    <div class="widget widget_special-offer">
      <h3
        class="widget_title title-dark mb-0"
        v-if="properties.header_title_t_ && properties.header_title_t_ != null"
      >
        {{ properties.header_title_t_ }}
      </h3>
      <div
        :class="
          properties.header_title_t_ && properties.header_title_t_ != null
            ? 'widget_content pt-10'
            : 'widget_content'
        "
      >
        <swiper
