<template>
  <section class="collection-section home-page-section">
    <!--Header -->
    <div
      class="align-items-center d-flex flex-md-row justify-content-between mb-15 section-header"
    ...
    >
      <div
        ...
        "
      >
        <h3 class="mb-0">{{ properties.section_title_t_ }}</h3>
      </div>
      <div
        class="btn-area"
        v-if="
        ...
        "
      >
        <a :href="properties.button_link" class="btn btn-sm">{{
          properties.section_btn_title_t_
        }}</a>
      </div>
    </div>
    ...
    <div
      :class="
        properties.featured_item_position &&
    ...
    >
      <div
        class="col-xxl-4 col-xl-5 col-lg-6 col-md-4 col-sm-5 mb-5 mb-sm-0 featured_item d-none d-lg-block"
        v-if="
      ...
      >
        <single-product
          :item="featuredItem"
          :featured-image="properties.featured_product_image"
          featuredStyle
        />
      </div>
      <div
