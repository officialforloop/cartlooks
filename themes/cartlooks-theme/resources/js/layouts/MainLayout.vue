...
export default {
  ...
  methods: {
    ...
    getAllMenusForEcommerceHome() {
      ...
      axios
        .get("/api/theme/cartlooks-theme/v1/get-all-menus-for-ecommerce-home", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
    ...
    getFooterWidget() {
      ...
      axios
        ...
        .get("/api/theme/cartlooks-theme/v1/get-footer-widgets", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
            ...
            for (const [key, value] of Object.entries(this.widget_options)) {
              if (key == "address_widget") {
                ...
                for (const [left_key, left_value] of Object.entries(value)) {
                  this.widget_html =
                    this.widget_html +
                    '<div class="col-lg-2 col-sm-6"><' +
                    key +
                ...
                for (const [right_key, left_value] of Object.entries(value)) {
                  this.widget_html =
                    this.widget_html +
                    '<div class="col-lg-2 col-sm-6"><' +
                    key +
    ...
    getThemeStyle() {
      ...
      axios
        .get("/api/theme/cartlooks-theme/v1/get-theme-style", {
          headers: headers,
        })
        .then((response) => {
          if (response.data.success) {
