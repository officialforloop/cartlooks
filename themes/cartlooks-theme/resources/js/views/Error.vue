<template>
  <div
    class="min-vh-100 vw-100 d-flex align-items-center justify-content-center bg-light"
  >
    <div class="custom-container2 my-5">
      <div
        :class="
      ...
      >
        <h1 class="text-danger">
          <span v-if="style404.custom_404 != 1">{{
            $t("Page Not Found")
          }}</span>
        ...
        <div class="img-404 mt-30 mb-30" v-if="style404.custom_404 != 1">
          <img
            src="/public/web-assets/frontend/themes/cartlooks-theme/assets/img/404.png"
            alt="404 Image"
          />
        </div>
...
export default {
  ...
  methods: {
    ...
    ge404Style() {
      axios
        .get("/api/theme/cartlooks-theme/v1/get-404-page-style")
        .then((response) => {
