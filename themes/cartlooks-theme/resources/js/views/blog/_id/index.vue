...
export default {
  ...
  methods: {
    ...
    getBlogThemeStyle() {
      axios
        .get("/api/theme/cartlooks-theme/v1/get-blog-theme-style")
        .then((response) => {
    ...
    getBlogDetails() {
      ...
      axios
        .get("/api/theme/cartlooks-theme/v1/blog/" + slug)
        .then((response) => {
          if (response.data.success) {
    ...
    postComment() {
      ...
      axios
        .post("/api/theme/cartlooks-theme/v1/blog/comment/create", request)
        .then((response) => {
          if (response.data.success) {
            this.comment = "";
            if (this.parent != "") {
    ...
    getBlogComments() {
      ...
      axios
        .post("/api/theme/cartlooks-theme/v1/blog/comment", request)
        .then((response) => {
          if (response.data.success) {
    ...
    getRelatedBlogs() {
      let slug = this.$route.params.id;
      axios
        .get("/api/theme/cartlooks-theme/v1/get-related-blogs?slug=" + slug)
        .then((response) => {
          if (response.data.success) {
