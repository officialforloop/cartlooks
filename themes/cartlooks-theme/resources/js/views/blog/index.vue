        ...
        <div class="row" v-if="!blog_page_style_loading">
          <div :class="blogsListLayoutClass">
            <template v-if="!blogs_loading">
              ...
              <div class="row align-items-center mt-10" v-if="blogs.length > 0">
                <div class="col-md-12">
                  <ul class="tl-pagination custom-pagination">
...
export default {
  ...
  methods: {
    ...
    getBlogs() {
      ...
      axios
        .get("/api/theme/cartlooks-theme/v1/blogs?page=" + this.currentPage)
        .then((response) => {
          if (response.data.success) {
            ...
            document.title = this.$t("All Blogs");
          }
