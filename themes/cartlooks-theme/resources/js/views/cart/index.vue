    ...
    <div class="pt-60 pb-60 light-bg">
      <div class="custom-container2">
        <div class="row" v-if="!dataLoading">
                    ...
                    <div class="col-lg-10 col-8">
                      <div class="row">
                        <div class="col-12 col-lg-8 description px-0">
                          ...
                          <p class="mb-1 product-variant fz-sm-12 c1">
                            <span>{{ $t("Unit Price") }}: </span>
                            <the-currency :amount="tdata.unitPrice">
                            </the-currency>
                          </p>
                          <p class="mb-1 product-price fz-sm-12">
                            <the-currency
          ...
          <!--No Items found-->
          <div class="col-12 text-center" v-if="!tableData.length">
            <img
              src="/public/web-assets/frontend/themes/cartlooks-theme/assets/img/empty-cart.png"
              alt="empty-cart"
              class="empty-cart-image mb-40"
            />
