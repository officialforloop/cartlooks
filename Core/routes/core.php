...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'site-map'], function () {
        Route::get('', [SiteMapController::class, 'sitemap'])->name('core.admin.site.map');
        Route::post('generate', [SiteMapController::class, 'generateSitemap'])->name('core.admin.site.map.generate')->middleware('demo');
        Route::get('download', [SiteMapController::class, 'downloadSitemap'])->name('core.admin.site.map.download');
    });
