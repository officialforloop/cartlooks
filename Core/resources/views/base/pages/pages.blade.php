        ...
        <div class="col-md-12">
            <div class="card mb-30">
                <div class="card-header d-flex justify-content-between align-items-center bg-white">
                    <h4 class="font-20">{{ translate('All Pages') }}</h4>
                    @can('Create Page')
                        <a href="{{ route('core.page.add') }}" class="btn long">{{ translate('Add New Page') }}</a>
                    @endcan
                </div>
                <div class="card-body">
                    {{-- Page Filter Buttons --}}
                    <div class="filter_button row mb-4 pl-3">
                        ...
                        <a href="{{ route('core.page') . '?status=mine' . $if_search }}" class="btn sm sm mx-1 my-2">
                                ...
                                @foreach ($pages as $page)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="/page-preview/{{ $page->permalink }}"
                                                    target="_blank">{{ $tlpage->translation('title', getLocale()) }}</a>
                                            @endif
