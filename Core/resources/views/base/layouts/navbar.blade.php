<nav class="sidebar" data-trigger="scrollbar">
    ...
    <div class="sidebar-body main-side-bar">
        ...
        <ul class="nav" id="main-nav">
            ...
            <!--System Module--->
            <li
                class="{{ Request::routeIs(['core.admin.site.map', 'core.language.frontend.translations', 'core.language.edit', 'core.language.key.values', 'core.languages', 'core.language.new', 'core.system.update.page', 'core.backup.files.list', 'core.backup.database.list']) ? 'active sub-menu-opened' : '' }}">
                <a href="#">
                ...
                <ul class="nav sub-menu">
                    ...
                    @if (auth()->user()->can('Manage Sitemap'))
