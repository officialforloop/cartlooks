                ...
                <div class="tab-pane fade show active">
                    ...
                    <div class="form-wrapper p-3">
                        <form action="{{ route('core.store.media.settings') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-sm-8">
                                    <select name="file_storage" class="theme-input-style file_storage_option">
                                        <option value="public" @if (isset($data['file_storage']) && $data['file_storage'] == 'public') selected @endif>
                                            {{ translate('Local') }}</option>
                                        <option value="amazons3" @if (isset($data['file_storage']) && $data['file_storage'] == 'amazons3') selected @endif>
                                            {{ translate('Amazon s3') }}</option>
                            ...
                            <div
                                class="amazon-s3-setup {{ isset($data['file_storage']) && $data['file_storage'] == 'amazons3' ? '' : 'd-none' }}">
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
