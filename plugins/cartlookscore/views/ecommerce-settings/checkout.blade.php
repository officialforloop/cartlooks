 <div class="card">
     <div class="card-body">
         ...
         <div class="form-row mb-20">
             <div class="col-sm-6">
                 <label class="font-14 bold black ">{{ translate('Required email in guest checkout') }}
                 </label>
             </div>
             <div class="col-sm-6">
                 <label class="switch glow primary medium">
                     <input type="checkbox" name="required_email_in_guest_checkout" @checked(getEcommerceSetting('required_email_in_guest_checkout') == config('settings.general_status.active'))>
                     <span class="control"></span>
                 </label>
             </div>
         </div>
                 ...
                 <div class="col-sm-6">
                     <label class="switch glow primary medium">
                         <input type="checkbox" name="enable_multiple_coupon_in_checkout"
                             @checked(getEcommerceSetting('enable_multiple_coupon_in_checkout') == config('settings.general_status.active'))>
                         <span class="control"></span>
                     </label>
                 </div>
             </div>
