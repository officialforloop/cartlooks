 @php
     ...
     $order_pickup_point_active_link_file =
         base_path() . '/plugins/pickuppoint-cartlooks/views/includes/submenu/order_active_link.json';
     ...
     $seller_products_active_link_file =
         base_path() . '/plugins/multivendor-cartlooks/views/includes/submenu/products_active_link.json';
     ...
     $order_seller_active_link_file =
         base_path() . '/plugins/multivendor-cartlooks/views/includes/submenu/order_active_link.json';
 ...
 @if (auth()->user()->can('Manage Add New Product') ||
         auth()->user()->can('Manage All Products') ||
 ...
 @php
     ...
     $shipping_carrier_active_link_file =
         base_path() . '/plugins/carrier-cartlooks/views/includes/submenu/shipping_active_link.json';
     ...
     $shipping_pickup_point_active_link_file =
         base_path() . '/plugins/pickuppoint-cartlooks/views/includes/submenu/shipping_active_link.json';
 ...
 @php
     ...
     $marketing_active_link_file =
         base_path() . '/plugins/flashdeal-cartlooks/views/includes/submenu/marketing_active_link.json';
     ...
     $marketing_coupon_active_link_file =
         base_path() . '/plugins/coupon-cartlooks/views/includes/submenu/marketing_active_link.json';
