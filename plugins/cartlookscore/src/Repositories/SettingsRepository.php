    ...
    public function updateEcommerceSettings($request)
    {
        try {
            ...
            $settings = [
                ...
                'required_email_in_guest_checkout'         => $request->has('required_email_in_guest_checkout') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
    ...
    public static function siteSettings()
    {
        try {
            $data = [
                ...
                'required_email_in_guest_checkout'        => self::getEcommerceSetting('required_email_in_guest_checkout'),
