        ...
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <form method="get" action="{{ route('plugin.multivendor.seller.dashboard.order.refund.list') }}">
                    ...
                    <a class="btn btn-danger long mb-auto"
                        href="{{ route('plugin.multivendor.seller.dashboard.order.refund.list') }}">{{ translate('Clear Filter') }}</a>
                            ...
                            @if ($refund_request_list->count() > 0)
                                @foreach ($refund_request_list as $key => $request)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('plugin.multivendor.seller.dashboard.order.details', ['id' => $request->order_id]) }}">
                                                {{ $request->order_code }}
                                        ...
                                        <td>
                                            ...
                                            @if (
                                                $request->payment_status != config('cartlookscore.return_request_payment_status.refunded') &&
                                                    $request->return_status != config('cartlookscore.return_request_status.approved'))
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title h6 bold">{{ translate('Update Refund Request Status') }}</h4>
        ...
        (function($) {
            ...
            $(".quick-view").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.multivendor.seller.dashboard.refund.request.quick.view') }}',
