...
@section('seller_main_content')
    @if (auth()->user()->shop->status == config('settings.general_status.active'))
        ...
        <form method="POST" class="row" id="product-form"
            action="{{ route('plugin.multivendor.seller.dashboard.products.update') }}">
            @csrf
                    ...
                    @foreach ($languages as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                href="{{ route('plugin.multivendor.seller.dashboard.products.edit', ['id' => $product_details->id, 'lang' => $language->code]) }}">
                    ...
                    <div class="card-body">
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" name="seller_id" value="{{ $product_details->supplier }}">
                        ...
                        <!--Permalink-->
                        <div class="form-row mb-20 permalink-input-group  @if ($errors->has('permalink')) d-flex @endif">
                            <div class="col-sm-3">
                                ...
                                <select class="product-unit-select form-control" name="unit">
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->id }}"
                                            @if ($product_details->unit != null && $product_details->unit == $unit->id) selected @endif>
                                    ...
                                    <div class="form-row mb-10">
                                        <div class="col-sm-3 mb-2">
                                            ...
                                            @php
                                                ...
                                                $choice_name = $attributes
                                                    ->where('id', $choice->choice_id)
                                                    ->first()
                                                    ->translation('name', getLocale());
                                            @endphp
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group d-flex">
                                                <select class="form-control choice-options-select"
                                                    ...
                                                    @php
                                                        $attribute_values = \Plugin\CartLooksCore\Models\AttributeValues::where(
                                                            'attribute_id',
                                                            $choice->choice_id,
                                                        )
                                                            ->where('status', config('settings.general_status.active'))
                                                ...
                                                @php
                                                    ...
                                                    foreach ($variant_array as $com_key => $variant) {
                                                        ...
                                                        if ($variant_com_array[0] === 'color') {
                                                            ...
                                                            $choice_name = \Plugin\CartLooksCore\Models\Colors::find(
                                                                $variant_com_array[1],
                                                            )->translation('name');
                                                        } else {
                                                            $option_name = $attributes
                                                                ->where('id', $variant_com_array[0])
                                                                ->first()
                                                                ->translation('name', getLocale());
                                                            $choice_name = \Plugin\CartLooksCore\Models\AttributeValues::find(
                                                                $variant_com_array[1],
                                                            )->name;
                                                        }
                                ...
                                <div class="col-sm-4">
                                    <select class="theme-input-style select2" name="discount_amount_type">
                                        ...
                                        <option value="{{ config('cartlookscore.amount_type.percent') }}"
                                            @if ($product_details->discount_type == config('cartlookscore.amount_type.percent')) selected @endif>
                        ...
                        @if (count($product_details->color_choices) > 0)
                            <div class="card-body">
                                @foreach ($product_details->color_choices as $key => $color)
                                    @php
                                        $color_name = \Plugin\CartLooksCore\Models\Colors::find(
                                            $color->color_id,
                                        )->translation('name');
                                        $color_images = \Plugin\CartLooksCore\Models\ProductColorVariantImages::where(
                                            'product_id',
                                            $product_details->id,
                                        )
                ...
                <div class="card mb-30 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                    ...
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <div class="col-sm-9">
                                @php
                                    $gallary_images = \Plugin\CartLooksCore\Models\ProductGalleryImages::where(
                                        'product_id',
                                        $product_details->id,
                                    )
                                        ->pluck('image_id')
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="video" class="theme-input-style"
                                    placeholder="{{ translate('Type here') }}"
                                    value="{{ $product_details->video_link }}">
                                @if ($errors->has('video'))
            ...
            <div class="col-lg-4 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                    ...
                    <div class="card-body">
                        ...
                        @if (getEcommerceSetting('shipping_option') == null ||
                            ...
                            <div class="shipping-zone-list">
                                @if ($product_details->shippingProfile != null)
                                    @include(
                                        'plugin/multivendor-cartlooks::seller.dashboard.pages.products.shipping_zone',
                                        ['id' => $product_details->shippingProfile->profile_id]
                                    )
                                @endif
                            </div>
                ...
                <!--Vat & Tax-->
                <div class="card mb-30">
                    <div class="card-header bg-white border-bottom2 py-3 py-3 py-3">
                        <div class="d-sm-flex justify-content-between align-items-center">
                    ...
                    <div class="card mb-30">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    <label class="switch glow primary medium">
                                        <input type="checkbox" name="is_active_attatchment" class="attatchment-required"
                                            onchange="attatchmentConfig()"
                                            @if ($product_details->is_active_attatchment == config('settings.general_status.active')) checked @endif>
                                        <span class="control"></span>
                                    </label>
                                </div>
                            </div>
                            <div
                                ...
                                <div class="form-row mb-20">
                                    <label class="font-14 bold black  col-sm-4">{{ translate('Attatchment Name') }}
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="text" class="theme-input-style"
