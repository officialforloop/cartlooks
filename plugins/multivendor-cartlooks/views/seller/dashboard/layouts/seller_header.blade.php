<header class="header white-bg fixed-top d-flex align-content-center flex-wrap">
    @include('plugin/multivendor-cartlooks::seller.dashboard.includes.headerLogo')
    <!-- Main Header -->
                        ...
                        @auth
                            <div class="main-header-user">
                                ...
                                <div class="dropdown-menu">
                                    <a
                                        href="{{ route('plugin.multivendor.seller.profile.page') }}">{{ translate('My Profile') }}</a>
                                    <a href="{{ route('plugin.multivendor.seller.logout') }}">{{ translate('Log Out') }}</a>
                                </div>
                            </div>
                        @endauth
