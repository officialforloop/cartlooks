                                            ...
                                            <div class="stock">
                                                ...
                                                @else
                                                    ...
                                                    @foreach ($v_prices as $key => $combination)
                                                        @php
                                                            $variant_array = explode(
                                                                '/',
                                                                trim($combination->variant, '/'),
                                                            );
                                                            $name = '';
                                                            foreach ($variant_array as $com_key => $variant) {
                                                                ...
                                                                if ($variant_com_array[0] === 'color') {
                                                                    ...
                                                                    $option_property = \Plugin\CartLooksCore\Models\ProductAttribute::select(
                                                                        ['id', 'name'],
                                                                    )->find($variant_com_array[0]);
                                                                    $option_name =
                                                                        $option_property != null
                                                                            ? $option_property->translation('name')
                                                                            : '';
                                                                    $choice_property = \Plugin\CartLooksCore\Models\AttributeValues::select(
                                                                        ['id', 'name'],
                                                                    )->find($variant_com_array[1]);
                                                                    $choice_name =
                                                                        $choice_property != null
                                                                            ? $choice_property->name
                                                                            : '';
                                                                }
                                            ...
                                            @php
                                                ...
                                                foreach ($order->products as $product) {
                                                    $total_payable_amount =
                                                        $total_payable_amount + $product->totalPayableAmount();
                                                }
                                            @endphp
                                    ...
                                    <tbody>
                                        @foreach ($refunds as $key => $refund)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($refund->refund_status == config('cartlookscore.return_request_payment_status.refunded'))
